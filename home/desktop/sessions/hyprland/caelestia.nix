...
#                Phase 3F (power bridge), not Phase 3E.
{
  ...
  # Activation scripts — all Caelestia-related home activation steps
  # grouped in a single attrset to satisfy statix repeated_keys.
  home.activation = {
    ...
    writeCaelestiaConfig = lib.hm.dag.entryAfter ["writeBoundary"] ''
    ...
    seedCaelestiaScheme = lib.hm.dag.entryAfter ["writeCaelestiaCliConfig"] ''
    ...
    createFaceSymlink = lib.hm.dag.entryAfter ["writeBoundary"] ''
